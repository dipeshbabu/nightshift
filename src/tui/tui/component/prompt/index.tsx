...
export function Prompt(props: PromptProps) {
  ...
  const [store, setStore] = createStore<{
    ...
    placeholder: Math.floor(Math.random() * DEFAULT_PLACEHOLDERS.length),
    prompt: {
      input: "",
      parts: [],
    },
        ...
        >
          ...
          >
            <textarea
              placeholder={(() => {
                if (props.sessionID) return undefined
                const prefix = "Ask anything..."
                const example = DEFAULT_PLACEHOLDERS[store.placeholder % DEFAULT_PLACEHOLDERS.length]
                return example ? `${prefix} "${example}"` : prefix
              })()}
